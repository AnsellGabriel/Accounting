...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference("Branch.count") do
      post branches_url, params: { branch: { Approver: @branch.Approver, Initials: @branch.Initials, branch_code: @branch.branch_code, branch_name: @branch.branch_name, position: @branch.position } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { Approver: @branch.Approver, Initials: @branch.Initials, branch_code: @branch.branch_code, branch_name: @branch.branch_name, position: @branch.position } }
