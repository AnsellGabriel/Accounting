...
class BanksTest < ApplicationSystemTestCase
  ...
  test "should create bank" do
    ...
    fill_in "Bank title", with: @bank.bank_title
    check "Check account" if @bank.check_account
    fill_in "Contact no", with: @bank.contact_no
    fill_in "Iorder", with: @bank.iOrder
