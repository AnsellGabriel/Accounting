...
class PayeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payee" do
    assert_difference("Payee.count") do
      post payees_url, params: { payee: { address: @payee.address, description: @payee.description, payee: @payee.payee } }
    end
  ...
  test "should update payee" do
    patch payee_url(@payee), params: { payee: { address: @payee.address, description: @payee.description, payee: @payee.payee } }
